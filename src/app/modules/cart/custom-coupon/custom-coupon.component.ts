...
@Component({
  selector: 'app-custom-coupon',
  templateUrl: './custom-coupon.component.html',
  styleUrls: ['./custom-coupon.component.scss']
})
export class CustomCouponComponent implements OnInit, OnDestroy {
